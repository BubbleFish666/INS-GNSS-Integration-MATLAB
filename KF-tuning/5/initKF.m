...
% KF.P(2,2) = 0.002^2;  % pitch variance (0.002 rad)^2
% KF.P(3,3) = 0.02^2;  % yaw variance (0.02 rad)^2
KF.P(1,1) = deg2rad(4)^2;  % roll variance
KF.P(2,2) = deg2rad(4)^2;  % pitch variance
...
% KF.P(13,13) = (deg2rad(8) / 3600)^2;  % gyro bias (8 deg/h)^2
KF.P(11,11) = (deg2rad(4))^2;
KF.P(12,12) = (deg2rad(4))^2;
KF.P(13,13) = (deg2rad(10))^2;
...
KF.Q(1:3 , 1:3) = (deg2rad(2.4) * T)^2 * eye(3);
