...
INS.llh_incre_total_corrected = [INS.lat_incre_total_fedback;
                                 INS.lon_incre_total_fedback;
                                 0];
INS.llh_corrected = [INS.lat0;
                     INS.lon0;
                     0];

INS.v_eb_n_corrected = INS.v_eb_n_fedback;
...
INS.eul_b0b_corrected = rotm2eul(INS.Rnb0' * INS.Rnb_fedback) * 180 / pi;
