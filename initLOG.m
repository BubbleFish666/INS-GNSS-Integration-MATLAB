...
% fedback INS
LOG.INS.v_eb_n_fedback(1:range_end-range_start+1, 1:2) = nan;
LOG.INS.eul_nb_fedback(1:range_end-range_start+1, 1:3) = nan;
LOG.INS.eul_b0b_fedback(1:range_end-range_start+1, 1:3) = nan;
% ok... I'm too lazy to change this llh here, but it works
LOG.INS.llh_fedback(1:range_end-range_start+1, 1:3) = nan;
...
LOG.KF.dpsi_nb(1:range_end-range_start+1, 1) = nan;
LOG.KF.dv_eb_n(1:range_end-range_start+1, 2) = nan;
LOG.KF.dllh(1:range_end-range_start+1, 2) = nan;
LOG.KF.ba(1:range_end-range_start+1, 2) = nan;
LOG.KF.bg(1:range_end-range_start+1, 1) = nan;
LOG.KF.P(1:range_end-range_start+1, 8, 8) = nan;
